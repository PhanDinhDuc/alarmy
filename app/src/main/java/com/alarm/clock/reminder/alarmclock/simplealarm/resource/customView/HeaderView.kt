...
import com.alarm.clock.reminder.alarmclock.simplealarm.databinding.CustomHeaderviewBinding
...
class HeaderView : FrameLayout, CustomHeader {
    ...
    private fun initView(attrs: AttributeSet?, @AttrRes defStyleAttr: Int) {
        ...
        try {
            ...
            title = customHeader.getResourceId(R.styleable.HeaderView_cs_title, R.string.snooze)
        } finally {
